  ...
  return (
    <>
      ...
      <div className='flex items-center gap-2 mt-4 '>
        <p className='bg-white text-black px-4 py-1 rounded2xl'>All</p>
        <p className='bg-black  px-4 py-1 rounded2xl cursor-pointer'>Music</p>
        <p className='bg-black  px-4 py-1 rounded2xl cursor-pointer'>Podcast</p>
      </div>
    </>
  )
}
